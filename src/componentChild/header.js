                ...
                <div className="collapse navbar-collapse me-5 ms-2" id="navbarNavAltMarkup">
                    <div className="navbar-nav ms-auto">
                            ...
                            :<>
                                ...
                                <div className="nav-item nav-link">
                                    <div className="btn-group dropstart mb-1">
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton2" style={{marginTop:45,marginRight:-80}}>
                                            <li>
                                ...
                                <div className="nav-item nav-link" data-bs-toggle="offcanvas" data-bs-target="#offcanvas" role="button">
                        ...
                        ?<div className="btn-group dropstart">
                            <img id="defaultDropdown" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false"
                                src={context.avatarUser}
                                alt="avatar" className="d-flex align-self-center me-3 dropdown-toggle rounded-circle" width="40"/>
                            
                            <ul className="dropdown-menu" style={{marginTop:55,marginRight:-40}}>
                                <li>
                                    <a className="dropdown-item text-success" onClick={()=>context.navigate('/profile')}>
                                        <i className="bi bi-person-circle me-2"></i>
                                        {context.acount}
                                    </a>
                                </li>
                                <li>
                                    <a className="dropdown-item"  data-bs-toggle="offcanvas" data-bs-target="#order" role="button">
